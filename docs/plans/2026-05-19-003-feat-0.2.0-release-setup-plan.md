...
- [ ] **Unit 1: Repo migration + Cargo.toml + URL cleanup** *(partial — URL/metadata cleanup landed in `019fa78`; remaining: create the four `llamadash-rs/*` GitHub repos and configure `CRATES_IO_TOKEN` + `GH_BUMP_TOKEN` secrets — both org-admin actions)*
...
- [ ] **Unit 2: Release workflow extensions**
...
- [ ] **Unit 4: Homebrew tap repo bootstrap + auto-bump**
...
- [ ] **Unit 5: Website scaffolding + Catppuccin theme + dispatch handler**
...
- [ ] **Unit 6: Website content + asciinema cast + FAQ + accessibility**
