...
- **Bundled snapshot size budget** → 500 KiB, enforced at build time (see Unit 5). _(Superseded by Unit 6 of [plan 2026-05-20-001](2026-05-20-001-feat-live-hf-snapshot-discovery-plan.md): raised to 2 MiB to fit the ~100-row live-discovery catalog.)_
