...
- [x] ~~HuggingFace pull TUI dialog with search / sort / pagination (origin: R46, [`docs/plans/2026-05-13-001-feat-llamatui-v1-launcher-plan.md`](docs/plans/2026-05-13-001-feat-llamatui-v1-launcher-plan.md)).~~ Shipped 2026-05-20 via [`docs/plans/2026-05-20-002-feat-hf-pull-tui-dialog-plan.md`](docs/plans/2026-05-20-002-feat-hf-pull-tui-dialog-plan.md) — `Ctrl+D` opens the Search / File picker / Confirm modal; downloads stream into the pinned status strip.
  - [x] ~~Models downloaded from HF has cryptic names; we should rename them to something human friendly and show that in the UI instead of the HF ID.~~ Shipped in the same slice — HF-cache rows now render as `<repo> (<quant>)`. Friendly names for Ollama / LM Studio / UserPath sources remain follow-up (R119).
- [ ] Friendly display names for non-HF sources (Ollama, LM Studio, UserPath) — R119 follow-up after [`docs/plans/2026-05-20-002-feat-hf-pull-tui-dialog-plan.md`](docs/plans/2026-05-20-002-feat-hf-pull-tui-dialog-plan.md).
